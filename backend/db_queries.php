<?php
	...
	$_SESSION["QUERIES"] = array(
		...
		'get_userid_by_login' => 'SELECT '.$_CFG["usertable_fields"]["user_id"].' FROM '.$_CFG["tables"]["users"].' WHERE '.$_CFG["usertable_fields"]["username"].'="@@_V_username" AND '.$_CFG["usertable_fields"]["password"].'=MD5(CONCAT("@@_V_password",'.$_CFG["usertable_fields"]["username"].'))',
		...
		'add_user_by_login' => 'INSERT INTO '.$_CFG["tables"]["users"].' ('.$_CFG["usertable_fields"]["username"].','.$_CFG["usertable_fields"]["password"].','.$_CFG["usertable_fields"]["created_date"].') VALUES ("@@_V_username",MD5("@@_V_password@@_V_username"),"@@_V_now")',

		// @@_V_NEWpassword, @@_V_username, @@_V_password
		'update_userpassword_by_login' => 'UPDATE '.$_CFG["tables"]["users"].' SET '.$_CFG["usertable_fields"]["password"].'=MD5("@@_V_NEWpassword@@_V_username") WHERE MD5('.$_CFG["usertable_fields"]["username"].')="@@_V_username" AND '.$_CFG["usertable_fields"]["password"].'=MD5("@@_V_password@@_V_username")',
